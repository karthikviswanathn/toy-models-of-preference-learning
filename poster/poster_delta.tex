...
\begin{posterbox}
\centering
\includegraphics[width=\linewidth]{figs/augmented_probes_delta.pdf}

\vspace{4pt}
\posterbody
Accuracy gain from adding squared PC features (mean $\pm$ std across 126 configs).
PC$^2$ augmentation substantially improves probes for \PTG{} at attention heads and post-MLP, confirming parity is encoded \textbf{nonlinearly} at these stages.
\POST{} shows negligible improvement.
\end{posterbox}
